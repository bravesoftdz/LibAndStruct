...
procedure All_OnResetDevice; //Реакция на возобновление фокуса
begin
...
begin
	...
	DLL_PROCESS_ATTACH:
		begin
		{ Эта функция осущесвляет перехват функции Direct3DCreate9,
		находящейся в библиотеке d3d9.dll
		и заменяет ее на вызов функции Direct3DCreate9Callback }
...
begin
	DllProc := @DLLEntryPoint; //Устанавливаем библиотечный обработчик
