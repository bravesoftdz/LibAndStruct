...
typedef double MATR_Mtype; /* Тип хранимых в матрице зничений */
...
/* Удаленет матрицу с очисткой памяти */
...
/* Возврещает указатель на элемент матрицы */
...
/* Решение матрицы методом Гауса (приведение к треугольному виду) */
...
/* sign принимает знак операуции измениения матричных значений (+, -, *, /)       */
